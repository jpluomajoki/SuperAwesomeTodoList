...
public class TodoListTest {
    ...
    final LocalDate ld2 = LocalDate.of(1970, Month.JANUARY, 2);
    ...
    public void createTodoList() {
        ...
        assertEquals(new ArrayList<TodoItem>(Arrays.asList(todoItem1)), new ArrayList<TodoItem>(Arrays.asList(todoItem1)));
